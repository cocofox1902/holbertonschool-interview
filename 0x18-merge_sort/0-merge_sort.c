...
/**
 * merge_sort - sorts an array of integers in ascending order using the top-down merge sort algorithm
...
/**
 * merge_sort_holder - sorts an array of integers in ascending order using the top-down merge sort algorithm
